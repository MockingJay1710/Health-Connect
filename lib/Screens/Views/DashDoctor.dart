...
import 'package:medical/Screens/Views/ProfilMedicalDoc.dart';
...
Widget _buildPatientCard(Map<String, dynamic> patient, BuildContext context) {
  return GestureDetector(
    onTap: () {
      // Navigate to the next page and pass the patient's email
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => ProfilMedicalDoc(
            patientEmail: patient['email'], // Pass the email
          ),
        ),
      );
    },
